...
contract contrato{ 
    ...
    constructor() public { 
        createReserva('none', 'none', 'nonde', 'none', 'none', 'none', '0000-00-00 00:00:00');
    } 

    function createReserva(string memory _identificadorReserva, string memory _codigoParqueadero, string memory _identificadorCupoParqueadero, string memory _placaVehiculo, string memory _fechaReserva, string memory _horaReserva, string memory _fechaHoraTransaccion) public { //Apertura de la función del contrato inteligente/smart contract
        counter ++;
